    ...
    return (
        <div>
            <div className="w-full min-h-screen">	
                <div className="flex justify-end mx-6 my-5 cursor-pointer" onClick={changeTheme}>
                ...
                <div className="flex flex-col gap-2 w-5/6 p-8 bg-[rgb(0,0,0,0.05)] rounded-xl md:py-10 md:px-15 md:w-1/3 mx-auto">
